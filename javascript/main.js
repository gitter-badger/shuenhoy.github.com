...
loadAsync('javascript/jquery-1.9.1.min.js', function() {
	load(['javascript/template.min.js',  'javascript/jsyaml.mini.js', 'javascript/sammy-latest.min.js', 'javascript/highlight.pack.js', 'javascript/showdown.js', 'javascript/showdown-ext/github.js', 'javascript/showdown-ext/table.js', 'http://tajs.qq.com/stats?sId=16049737'], function() {
